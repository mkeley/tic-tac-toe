...
#puts "Select a piece from the board from a to i"
#gets.chomp = choice
#puts choice
class TicTacToe
    # initialize
...
class Player
    ...
    def ask_for_coordinates
        ...
        puts "#{@name}(#{@piece}), enter your coordinates in the form an integer from 0 to 8"
...
class Board
    ...
    def within_valid_coordinates?(coords)
        ...
        if (0..8).include?(coords['']) && (0..8).include?(coords[''])
            true
        else
    ...
    def horizontals
        ...
        3.times do |i|
            ...
            horizontals << [[@board[3][i],@board[4][i],@board[5][i]] ]
            horizontals << [[@board[6][i],@board[7][i],@board[8][i]] ]
